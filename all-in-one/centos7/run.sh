...
ENV_VARS="-e STORM_TARGET_RELEASE=${STORM_TARGET_RELEASE} -e VOMS_TARGET_RELEASE=${VOMS_TARGET_RELEASE} -e PKG_STORM_BRANCH=${PKG_STORM_BRANCH} -e PKG_VOMS_BRANCH=${PKG_VOMS_BRANCH}"
