...
cp /assets/storm-certificates/star.test.example.cert.pem /etc/grid-security/hostcert.pem
cp /assets/storm-certificates/star.test.example.key.pem /etc/grid-security/hostkey.pem
